...
const Shop = () => {
    ...
    return ( 
        <div className="shop__contianer">
            {loading && <ReactLoading type="balls" color='rgb(222,222,222)'  height={100} width={100} className='container h-100 w-10 justify-self-center align-self-center m-auto'/>}
