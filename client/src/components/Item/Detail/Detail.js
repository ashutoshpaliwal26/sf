                ...
                <div className="collect__item__actions">
                    <div className="add__cart__add__wish">
                        <div className="add__cart">
                            <Button variant="outlined" size="large" sx={[{'&:hover': { backgroundColor: 'rgb(222,222,222)', borderColor: 'rgb(222,222,222)', borderWidth: '3px', color: 'black'}, minWidth: 200, borderColor: 'black', backgroundColor: "black" , color: "rgb(222,222,222)", borderWidth: '3px'}]} onClick={handelAddToCart}>ADD TO BAG</Button>
                        </div>
                        <div className="add__wish">
                            <IconButton variant="outlined" size="large" sx={[{'&:hover': { backgroundColor: 'rgb(222,222,222)', borderColor: 'rgb(222,222,222)', borderWidth: '3px', color: 'black'}, borderColor: 'black', backgroundColor: "black" , color: "rgb(222,222,222)", borderWidth: '3px'}]} onClick={handelAddToWish}>
