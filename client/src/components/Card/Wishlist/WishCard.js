    ...
    return ( 
        <div className="wishcard">
            ...
            <div className="add__to__cart">
                <Button variant='outlined' onClick={handelAddToCart} sx={[{'&:hover': { backgroundColor: 'rgb(222,222,222)', borderColor: 'rgb(222,222,222)', color: 'black'}, borderColor: 'black', backgroundColor: "black" , color: "rgb(222,222,222)"}]}>Add to cart</Button>
            </div>
        </div>
     );
}
